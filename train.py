...
for epoch in range(opt.epoch, opt.n_epochs):
    for i, (real_B, real_A, _) in enumerate(dataloader):
        # real_B is image ,real_A is label
        ...
        loss_D_mse =criterion_mse(fake_AB, real_AB)
        loss_D = (loss_D_fake + loss_D_real + loss_D_mse) * 0.5
        ...
        loss_G = loss_G_GAN + lambda_pixel * loss_G_L1 + loss_G_mse
